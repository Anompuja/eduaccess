...
Future<void> showTeacherDetailModal(
  BuildContext context, {
  required TeacherRowData data,
}) {
  return showDialog<void>(
    context: context,
    builder: (_) => TeacherDetailModal(data: data),
  );
}

class TeacherDetailModal extends StatelessWidget {
  final TeacherRowData data;

  const TeacherDetailModal({super.key, required this.data});
            ...
            children: [
              ...
              _DetailSection(
                ...
                children: [
                  ...
                  _DetailItem(label: 'Kartu Identitas', value: data.ktpImagePath),
                  _DetailItem(label: 'Kewarganegaraan', value: data.kewarganegaraan),
                  _DetailItem(label: 'Golongan Darah', value: data.golonganDarah),
                  _DetailItem(label: 'Berat Badan', value: data.beratBadan),
                  _DetailItem(label: 'Tinggi Badan', value: data.tinggiBadan),
                  _DetailItem(label: 'Penyakit yang Sering Kambuh', value: data.penyakitYangSeringKambuh),
                  _DetailItem(label: 'Kelainan Jasmani', value: data.kelainanJasmani),
                  _DetailItem(label: 'Penyakit Kronis yang Pernah Diderita', value: data.penyakitKronisYangPernahDiderita),
                  _DetailItem(label: 'RT/RW', value: data.rtRw),
                  _DetailItem(label: 'Kode Pos', value: data.kodePos),
                  _DetailItem(label: 'NUPTK', value: data.nuptk),
                ],
              ),
              ...
              _DetailSection(
                ...
                children: [
                  ...
                  _DetailItem(label: 'Jurusan', value: data.jurusan),
                  _DetailItem(label: 'Tahun Masuk', value: data.tahunMasuk),
                  _DetailItem(label: 'Tahun Lulus', value: data.tahunLulus),
                ],
              ),
              const SizedBox(height: AppSpacing.lg),
              _DetailSection(
