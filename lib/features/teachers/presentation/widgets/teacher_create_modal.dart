...
Future<void> showTeacherCreateModal(BuildContext context) {
  return showDialog<void>(
    context: context,
    builder: (_) => const TeacherCreateModal(),
  );
}

class TeacherCreateModal extends StatefulWidget {
  const TeacherCreateModal({super.key});

  @override
  State<TeacherCreateModal> createState() => _TeacherCreateModalState();
}

class _TeacherCreateModalState extends State<TeacherCreateModal> {
