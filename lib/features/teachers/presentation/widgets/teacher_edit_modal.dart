...
Future<void> showTeacherEditModal(
  ...
  return showDialog<void>(
    context: context,
    builder: (_) => TeacherEditModal(data: data),
  );
}

class TeacherEditModal extends StatefulWidget {
  final TeacherRowData data;

  const TeacherEditModal({super.key, required this.data});

  @override
  State<TeacherEditModal> createState() => _TeacherEditModalState();
}

class _TeacherEditModalState extends State<TeacherEditModal> {
  ...
  void initState() {
    ...
    _subjectCtrl = TextEditingController(text: widget.data.subject);
