...
class StudentsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final schoolId = user?.role == UserRole.superadmin
        ? activeSchool?.id
        : user?.schoolId;
    final subscriptionOverviewAsync = schoolId == null
        ? null
        : ref.watch(
    ...
    void setSearch(String value) {
      ref.read(studentsSearchQueryProvider.notifier).state = value
          .toLowerCase()
          .trim();
      ref.read(studentsCurrentPageProvider.notifier).state = 1;
    }
      ...
      child: Column(
        ...
        children: [
          ...
          if (subscriptionOverviewAsync != null) ...[
            const SizedBox(height: AppSpacing.md),
            _StudentQuotaBanner(
              subscriptionOverviewAsync: subscriptionOverviewAsync,
            ),
          ],
          const SizedBox(height: AppSpacing.md),
          if (isSmallScreen)
              ...
              children: [
                ...
                AppDropdown<String?>(
                  ...
                  items: [
                    ...
                    ...levels.map(
                      (l) => AppDropdownItem(value: l.id, label: l.name),
                    ),
                  ],
                  onChanged: (v) {
                  ...
                  items: [
                    ...
                    ...classes
                        .where(
                          (c) =>
                              levelFilter == null ||
                              c.educationLevelId == levelFilter,
                        )
                        .map(
                ...
                AppDropdown<String?>(
                  ...
                  items: [
                    ...
                    ...subClasses
                        ...
                        .map(
                          (s) => AppDropdownItem(value: s.id, label: s.name),
                        ),
                  ],
                  onChanged: (v) {
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: AppDropdown<String?>(
                    ...
                    onChanged: (v) {
                      ref.read(studentsSubClassFilterProvider.notifier).state =
                          v;
                      ref.read(studentsCurrentPageProvider.notifier).state = 1;
                    },
                  ),
            ...
            data: (result) {
              ...
              if (rows.isEmpty) {
                ...
                if (hasSearch) {
                  ...
                  subtitle =
                      'Tidak ditemukan siswa dengan kata kunci "$searchQuery". Coba ubah pencarian.';
                } else if (activeSchool != null) {
                  message = 'Tidak ada data siswa yang tersedia di sekolah ini';
                  subtitle =
                      'Belum ada siswa terdaftar untuk ${activeSchool.name}. Tambahkan siswa baru.';
                } else {
                            ...
                            child: Theme(
                              ...
                              child: DataTable(
                                ...
                                rows: rows.asMap().entries.map((entry) {
                                  ...
                                  final e = entry.value;
                                  final startIndex =
                                      (result.page - 1) * result.perPage;
                                  return DataRow(
                                    cells: [
                                      DataCell(
                                        SizedBox(
                                          width: StudentsScreenConstants
                                              .noColumnWidth,
                                          child: Text(
                                            '${startIndex + index + 1}',
                          ...
                          Center(
                            child: AppPagination(
                              ...
                              onPageChanged: (page) {
                                ref
                                        .read(
                                          studentsCurrentPageProvider.notifier,
                                        )
                                        .state =
                                    page;
                              },
...
class _StudentQuotaBanner extends StatelessWidget {
  final AsyncValue<SchoolSubscriptionOverview> subscriptionOverviewAsync;

  const _StudentQuotaBanner({required this.subscriptionOverviewAsync});
    ...
    return subscriptionOverviewAsync.when(
      loading: () => const AppCard(
        child: Padding(
          ...
          child: Text('Memuat kuota siswa paket aktif...'),
        ),
      ),
      ...
      data: (overview) {
        ...
        final icon = isAtCapacity
            ? Icons.block_rounded
            : isNearCapacity
            ? Icons.warning_amber_rounded
            : Icons.verified_outlined;
        final message = isAtCapacity
            ? 'Kuota siswa paket ${overview.plan.tier.label} sudah penuh. Tambah siswa baru akan ditolak sampai paket di-upgrade.'
            : 'Paket ${overview.plan.tier.label}: ${overview.studentsUsed}/${overview.studentsLimit} siswa terpakai. Sisa kuota ${overview.remainingStudents}.';
